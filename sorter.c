...
->if encountered with csv file, calls the function from the part 0.
...
int sort_file(char input_file_name[],char output_file_name[],char sort[]){
	...
	fgets(header,1000,file);//getting the header
